        ...
        */
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function performPageSearch(query) {
                ...
                if (modalTitle) modalTitle.innerHTML = '<i class="fa-solid fa-search"></i> نتائج البحث';
                ...
                if (searchIframe) {
                    ...
                    currentFrameUrl = searchUrl;
                    searchIframe.src = searchUrl;
                }
            }

            // Global Topic Frame Function
            window.showTopicFrame = function (url) {
                const searchIframe = document.getElementById('forumSearchIframe');
                const modalTitle = document.getElementById('mainModalTitle');

                if (modalTitle) modalTitle.innerHTML = '<i class="fa-solid fa-book-open"></i> معاينة الموضوع';
                if (searchIframe) {
                    currentFrameUrl = url;
